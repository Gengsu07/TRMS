...
# Function/module
def cek_data(var):
    """Cek data apakah ada atau tidak sehingga tidak error"""
...
if st.session_state["authentication_status"] is False:
    ...
    try:
        ...
        with chart_container(jenis_wp.reset_index()):
            ...
            # ]
            st.dataframe(filter_dataframe(jenis_wp, key=2), use_container_width=True)
        ...
        with st.container():
            ...
            with tab_wp[0]:
                ...
                with chart_container(bruto):
                    st.dataframe(
                        filter_dataframe(bruto, key=3), use_container_width=True
                    )
            with tab_wp[1]:
